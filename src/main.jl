...
# Set a name to create a folder to store results in.
results_folder_name = "my_results2"
...
# Calculate index for the year 2020 (DICE-FARM runs fro 1765-2500 by default).
